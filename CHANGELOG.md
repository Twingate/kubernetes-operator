...
- Delete the gateway's Twingate CRs before the operator on uninstall
  ([#1120](https://github.com/Twingate/kubernetes-operator/pull/1120),
  [`10ea93f`](https://github.com/Twingate/kubernetes-operator/commit/10ea93fc897133a71bf4aebbbfab4fdff91795a8))

- Recreate `TwingateResource` when the k8s service's `resource.twingate.com/type` annotation value
  changes ([#1122](https://github.com/Twingate/kubernetes-operator/pull/1122),
  [`d128acb`](https://github.com/Twingate/kubernetes-operator/commit/d128acb0dc8c45e59ecc6b6dd41b20a0004cb8f6))
...
- Bump actions/cache from 5.0.5 to 6.0.0
  ([#1054](https://github.com/Twingate/kubernetes-operator/pull/1054),
  [`d3a4f4c`](https://github.com/Twingate/kubernetes-operator/commit/d3a4f4c623f743246db136aeecee8d42ab00fc4d))

- Bump actions/cache from 6.0.0 to 6.1.0
  ([#1061](https://github.com/Twingate/kubernetes-operator/pull/1061),
  [`d9ff8ff`](https://github.com/Twingate/kubernetes-operator/commit/d9ff8ff3a2178d022fbd3eeff49772efa7f78637))

- Bump actions/checkout from 6.0.3 to 7.0.0
  ([#1047](https://github.com/Twingate/kubernetes-operator/pull/1047),
  [`a457403`](https://github.com/Twingate/kubernetes-operator/commit/a457403f866c175ecc7c89d607e397304d1bf5f8))

- Bump actions/checkout from 7.0.0 to 7.0.1
  ([#1087](https://github.com/Twingate/kubernetes-operator/pull/1087),
  [`1ce5e89`](https://github.com/Twingate/kubernetes-operator/commit/1ce5e898a9486aa013736d7e3058a9f99fa342c7))

- Bump actions/setup-python from 6.2.0 to 6.3.0
  ([#1055](https://github.com/Twingate/kubernetes-operator/pull/1055),
  [`da0ad07`](https://github.com/Twingate/kubernetes-operator/commit/da0ad07077a4c4e0d024f9cde8842eed8af0110e))

- Bump actions/setup-python from 6.3.0 to 7.0.0
  ([#1086](https://github.com/Twingate/kubernetes-operator/pull/1086),
  [`c9012e8`](https://github.com/Twingate/kubernetes-operator/commit/c9012e83d33979c16c99dd959a0d6950379ed64a))

- Bump actions/stale from 10.3.0 to 10.4.0
  ([#1073](https://github.com/Twingate/kubernetes-operator/pull/1073),
  [`168e493`](https://github.com/Twingate/kubernetes-operator/commit/168e493eddf303e9f32e036954b61b91b9a5dd0f))

- Bump actions/stale from 10.4.0 to 11.0.0
  ([#1107](https://github.com/Twingate/kubernetes-operator/pull/1107),
  [`08d5e23`](https://github.com/Twingate/kubernetes-operator/commit/08d5e23888ad8c599e32f034ff11b94af76f9168))

- Bump aiohttp from 3.14.1 to 3.14.3
  ([#1118](https://github.com/Twingate/kubernetes-operator/pull/1118),
  [`a0bbe14`](https://github.com/Twingate/kubernetes-operator/commit/a0bbe14f40916e18a9ca05d1b0df82242b142e54))

- Bump azure/setup-helm from 5.0.0 to 5.0.1
  ([#1053](https://github.com/Twingate/kubernetes-operator/pull/1053),
  [`4cfabc4`](https://github.com/Twingate/kubernetes-operator/commit/4cfabc43fb8935626a8882756ab76d3599a3ce05))

- Bump croniter from 6.2.2 to 6.2.3
  ([#1066](https://github.com/Twingate/kubernetes-operator/pull/1066),
  [`60e65c3`](https://github.com/Twingate/kubernetes-operator/commit/60e65c3f5b9f9a3f2ec80ed5dbeeeab7aeed62a7))

- Bump croniter from 6.2.3 to 6.2.4
  ([#1074](https://github.com/Twingate/kubernetes-operator/pull/1074),
  [`58fabb0`](https://github.com/Twingate/kubernetes-operator/commit/58fabb076ae2699c2e76388722f452a55ab54b4c))

- Bump cryptography from 49.0.0 to 50.0.0
  ([#1117](https://github.com/Twingate/kubernetes-operator/pull/1117),
  [`9f9750e`](https://github.com/Twingate/kubernetes-operator/commit/9f9750e37f3a3f71a56c0984452b7cc790864a37))

- Bump danger/danger-js from 13.0.5 to 13.0.8
  ([#1048](https://github.com/Twingate/kubernetes-operator/pull/1048),
  [`2c59d5d`](https://github.com/Twingate/kubernetes-operator/commit/2c59d5d2665b8360aa65f278258eee2c0b50d27e))

- Bump danger/danger-js from 13.0.8 to 13.0.10
  ([#1058](https://github.com/Twingate/kubernetes-operator/pull/1058),
  [`28ed1b3`](https://github.com/Twingate/kubernetes-operator/commit/28ed1b3b51e9789843178f257b3df75f435f966e))

- Bump docker/login-action from 4.2.0 to 4.3.0
  ([#1064](https://github.com/Twingate/kubernetes-operator/pull/1064),
  [`9433658`](https://github.com/Twingate/kubernetes-operator/commit/9433658165f17f5ad291855f26a34fde3d30eaf0))

- Bump docker/login-action from 4.3.0 to 4.4.0
  ([#1067](https://github.com/Twingate/kubernetes-operator/pull/1067),
  [`33491da`](https://github.com/Twingate/kubernetes-operator/commit/33491dac8570be4898cecf3e3c01eb85cb296c21))

- Bump docker/login-action from 4.4.0 to 4.5.0
  ([#1097](https://github.com/Twingate/kubernetes-operator/pull/1097),
  [`49bfed4`](https://github.com/Twingate/kubernetes-operator/commit/49bfed4cbc903d65773b21776b7893bc5d2fe1a7))

- Bump docker/login-action from 4.5.0 to 4.5.1
  ([#1102](https://github.com/Twingate/kubernetes-operator/pull/1102),
  [`86173b0`](https://github.com/Twingate/kubernetes-operator/commit/86173b0522727a3d2cecbe4194df259bd6d2c946))

- Bump docker/login-action from 4.5.1 to 4.6.0
  ([#1111](https://github.com/Twingate/kubernetes-operator/pull/1111),
  [`5b7c834`](https://github.com/Twingate/kubernetes-operator/commit/5b7c834afb81b79324191286ea3d304d0ea67244))

- Bump docker/setup-buildx-action from 4.1.0 to 4.2.0
  ([#1065](https://github.com/Twingate/kubernetes-operator/pull/1065),
  [`43fd637`](https://github.com/Twingate/kubernetes-operator/commit/43fd6372f2ef77dc3eccdcab655becf2cb99a590))

- Bump docker/setup-qemu-action from 4.1.0 to 4.2.0
  ([#1062](https://github.com/Twingate/kubernetes-operator/pull/1062),
  [`94b2805`](https://github.com/Twingate/kubernetes-operator/commit/94b28053b2eb2f774899eaa4e884ca508e2f8016))

- Bump gateway from 0.18.0 to 0.19.0 in /deploy/twingate-operator
  ([#1076](https://github.com/Twingate/kubernetes-operator/pull/1076),
  [`cbb99b6`](https://github.com/Twingate/kubernetes-operator/commit/cbb99b622c1f7ec48ba98c9c3e50f3e6402d643d))

- Bump gateway from 0.19.0 to 0.19.1 in /deploy/twingate-operator
  ([#1082](https://github.com/Twingate/kubernetes-operator/pull/1082),
  [`6c73b46`](https://github.com/Twingate/kubernetes-operator/commit/6c73b4613af6b90e6626065b4e360d4ff6b7661e))

- Bump gateway from 0.19.1 to 0.21.0 in /deploy/twingate-operator
  ([#1088](https://github.com/Twingate/kubernetes-operator/pull/1088),
  [`8810d79`](https://github.com/Twingate/kubernetes-operator/commit/8810d79a73462a50fe80c8c091601bbf7c08ac53))

- Bump gateway from 0.21.0 to 0.21.1 in /deploy/twingate-operator
  ([#1091](https://github.com/Twingate/kubernetes-operator/pull/1091),
  [`cc7f766`](https://github.com/Twingate/kubernetes-operator/commit/cc7f766b40ab92f60fd8820593e000a00193fb6e))

- Bump gateway from 0.21.1 to 0.22.0 in /deploy/twingate-operator
  ([#1095](https://github.com/Twingate/kubernetes-operator/pull/1095),
  [`eb3fbeb`](https://github.com/Twingate/kubernetes-operator/commit/eb3fbeb2327e8843e53a4c31f6e4bd2dfe84005d))

- Bump gateway from 0.22.0 to 0.22.1 in /deploy/twingate-operator
  ([#1105](https://github.com/Twingate/kubernetes-operator/pull/1105),
  [`0f965ad`](https://github.com/Twingate/kubernetes-operator/commit/0f965ad04bd86228404b62f9640b0f89b27f0865))

- Bump gateway from 0.22.1 to 1.0.0 in /deploy/twingate-operator
  ([#1116](https://github.com/Twingate/kubernetes-operator/pull/1116),
  [`a768c5b`](https://github.com/Twingate/kubernetes-operator/commit/a768c5b540ed13202193fb140637538e349ee5b2))

- Bump hadolint/hadolint-action from 3.3.0 to 3.4.0
  ([#1114](https://github.com/Twingate/kubernetes-operator/pull/1114),
  [`cc89233`](https://github.com/Twingate/kubernetes-operator/commit/cc892333ea8199abac3fe4a77b09038bb4a23c78))

- Bump kubernetes from 36.0.2 to 36.0.3
  ([#1081](https://github.com/Twingate/kubernetes-operator/pull/1081),
  [`68f15ea`](https://github.com/Twingate/kubernetes-operator/commit/68f15ea583b348c5136d6fc701670f1f21fb3805))

- Bump mypy from 2.1.0 to 2.2.0 ([#1071](https://github.com/Twingate/kubernetes-operator/pull/1071),
  [`9e34217`](https://github.com/Twingate/kubernetes-operator/commit/9e342177348eb5531f3d29fa63265b75f514daf7))

- Bump mypy from 2.2.0 to 2.3.0 ([#1079](https://github.com/Twingate/kubernetes-operator/pull/1079),
  [`fb757e8`](https://github.com/Twingate/kubernetes-operator/commit/fb757e823773a6e4a9b2b03925b1c52d65d0c01f))

- Bump pre-commit from 4.6.0 to 4.6.1
  ([#1092](https://github.com/Twingate/kubernetes-operator/pull/1092),
  [`7320036`](https://github.com/Twingate/kubernetes-operator/commit/732003695b73273ec27eedbe0c4e8d939ba938d6))

- Bump pyasn1 from 0.6.3 to 0.6.4
  ([#1093](https://github.com/Twingate/kubernetes-operator/pull/1093),
  [`2c5f31b`](https://github.com/Twingate/kubernetes-operator/commit/2c5f31b3d66683da6f5898dabcc638e5caeb3369))

- Bump pydantic-settings from 2.14.1 to 2.14.2
  ([#1051](https://github.com/Twingate/kubernetes-operator/pull/1051),
  [`95ba8b6`](https://github.com/Twingate/kubernetes-operator/commit/95ba8b6aac7e389f96aa40fa96b4975771ed6ccc))

- Bump pydantic-settings from 2.14.2 to 2.15.0
  ([#1123](https://github.com/Twingate/kubernetes-operator/pull/1123),
  [`45aedfb`](https://github.com/Twingate/kubernetes-operator/commit/45aedfbbb332f8c37d3aca9081daa9357412087a))

- Bump pytest from 9.1.0 to 9.1.1
  ([#1049](https://github.com/Twingate/kubernetes-operator/pull/1049),
  [`5cb0621`](https://github.com/Twingate/kubernetes-operator/commit/5cb0621f8d73badeae5a9bf043a0739c565947bc))

- Bump responses from 0.26.1 to 0.26.2
  ([#1068](https://github.com/Twingate/kubernetes-operator/pull/1068),
  [`402c616`](https://github.com/Twingate/kubernetes-operator/commit/402c616e53cf43c1ac425434f3ddc9610f0d9342))

- Bump ruff from 0.15.17 to 0.15.18
  ([#1050](https://github.com/Twingate/kubernetes-operator/pull/1050),
  [`951b702`](https://github.com/Twingate/kubernetes-operator/commit/951b70240313a19a5ee40dbb3fbeb1708c5d3289))

- Bump ruff from 0.15.18 to 0.15.19
  ([#1056](https://github.com/Twingate/kubernetes-operator/pull/1056),
  [`4ee51fc`](https://github.com/Twingate/kubernetes-operator/commit/4ee51fca68ad3d5764d3d4eb861282615e862de4))

- Bump ruff from 0.15.19 to 0.15.20
  ([#1060](https://github.com/Twingate/kubernetes-operator/pull/1060),
  [`c091349`](https://github.com/Twingate/kubernetes-operator/commit/c091349a3895852d278f88e2bec2242bbad78341))

- Bump ruff from 0.15.20 to 0.15.21
  ([#1075](https://github.com/Twingate/kubernetes-operator/pull/1075),
  [`2d2b68c`](https://github.com/Twingate/kubernetes-operator/commit/2d2b68ccb8472c72eec42f1ac6c29d1cb56911c3))

- Bump ruff from 0.15.21 to 0.15.22
  ([#1085](https://github.com/Twingate/kubernetes-operator/pull/1085),
  [`592dc81`](https://github.com/Twingate/kubernetes-operator/commit/592dc81afd286ef404fec33a89fe80dc2e3eca07))

- Bump ruff from 0.15.22 to 0.16.0
  ([#1098](https://github.com/Twingate/kubernetes-operator/pull/1098),
  [`de5effe`](https://github.com/Twingate/kubernetes-operator/commit/de5effef6d154d7035046719ff960d32194c0a34))

- Bump ruff from 0.16.0 to 0.16.1
  ([#1115](https://github.com/Twingate/kubernetes-operator/pull/1115),
  [`7347166`](https://github.com/Twingate/kubernetes-operator/commit/7347166d9c93fd2cbac5a2a3f7b02f021a451207))

- Bump ruff from 0.16.1 to 0.16.2
  ([#1124](https://github.com/Twingate/kubernetes-operator/pull/1124),
  [`53bcfed`](https://github.com/Twingate/kubernetes-operator/commit/53bcfed5cd026f17b6517f74c3b3fd1f57fe5ad3))

- Bump syrupy from 5.3.2 to 5.3.3
  ([#1057](https://github.com/Twingate/kubernetes-operator/pull/1057),
  [`289effd`](https://github.com/Twingate/kubernetes-operator/commit/289effd601f8fb8b076b2f6bda38f432e4005fed))

- Bump syrupy from 5.3.3 to 5.3.4
  ([#1059](https://github.com/Twingate/kubernetes-operator/pull/1059),
  [`ffd8678`](https://github.com/Twingate/kubernetes-operator/commit/ffd86786595ff23e3ab8e4fd4a83802b5195c0ad))

- Bump syrupy from 5.3.4 to 5.4.0
  ([#1063](https://github.com/Twingate/kubernetes-operator/pull/1063),
  [`889db4b`](https://github.com/Twingate/kubernetes-operator/commit/889db4bc14c2a18567a90f3840879a4775ff33c1))

- Bump syrupy from 5.4.0 to 5.5.1
  ([#1070](https://github.com/Twingate/kubernetes-operator/pull/1070),
  [`33e9e6c`](https://github.com/Twingate/kubernetes-operator/commit/33e9e6c3922f39e0cc2830737785da8d246ee9f7))

- Bump syrupy from 5.5.1 to 5.5.2
  ([#1072](https://github.com/Twingate/kubernetes-operator/pull/1072),
  [`61c41df`](https://github.com/Twingate/kubernetes-operator/commit/61c41df69499b93013b89f47ae5cf53c04cfced7))

- Bump syrupy from 5.5.2 to 5.5.3
  ([#1077](https://github.com/Twingate/kubernetes-operator/pull/1077),
  [`2c61d34`](https://github.com/Twingate/kubernetes-operator/commit/2c61d34b6c96e6d7dcb10c8e9e22033eaec1130f))

- Bump types-croniter from 6.2.2.20260518 to 6.2.3.20260704
  ([#1069](https://github.com/Twingate/kubernetes-operator/pull/1069),
  [`6b78b44`](https://github.com/Twingate/kubernetes-operator/commit/6b78b44587983b02a960c87b5da28c8c9224f20c))

- Bump types-croniter from 6.2.3.20260704 to 6.2.4.20260711
  ([#1078](https://github.com/Twingate/kubernetes-operator/pull/1078),
  [`a7a001f`](https://github.com/Twingate/kubernetes-operator/commit/a7a001f56d0b1edb32df108fc051247a00d931d1))

- Bump types-pyyaml from 6.0.12.20260518 to 6.0.12.20260724
  ([#1099](https://github.com/Twingate/kubernetes-operator/pull/1099),
  [`6c9d7fe`](https://github.com/Twingate/kubernetes-operator/commit/6c9d7fe99cfea4f5f7f760336b32176524cd8aaa))

- Bump types-requests from 2.33.0.20260518 to 2.33.0.20260712
  ([#1080](https://github.com/Twingate/kubernetes-operator/pull/1080),
  [`8c477d2`](https://github.com/Twingate/kubernetes-operator/commit/8c477d28f3ff8ca3fda8f6384c05a4d0ae53bf66))

- Rename "Kubernetes Access Gateway" references in Helm unit test
  ([#1096](https://github.com/Twingate/kubernetes-operator/pull/1096),
  [`0ffa7d1`](https://github.com/Twingate/kubernetes-operator/commit/0ffa7d15901362aa5f9e8129f42b2193790dbad7))

- Support hotfixes in semantic release
  ([`6b1cbc1`](https://github.com/Twingate/kubernetes-operator/commit/6b1cbc17d38d1ebfc1915b20a88834a08d2b7c9e))

- Upgrade to Python 3.14 ([#1031](https://github.com/Twingate/kubernetes-operator/pull/1031),
  [`62b2cde`](https://github.com/Twingate/kubernetes-operator/commit/62b2cde258be096915a49d31abd279eca7674b69))

### Continuous Integration

- Ignore dependency cooldown setting for Gateway Helm chart
  ([#1113](https://github.com/Twingate/kubernetes-operator/pull/1113),
  [`87bb39f`](https://github.com/Twingate/kubernetes-operator/commit/87bb39f842562148c48974f02f21a9e21906a495))

### Documentation

- Minor README change
  ([`3245e74`](https://github.com/Twingate/kubernetes-operator/commit/3245e746b70d3249b901127e7750d98a9a79adf9))

### Features

- Add `gatewayRef` to `TwingateResource` and update Gateway subchart
  ([#1041](https://github.com/Twingate/kubernetes-operator/pull/1041),
  [`6971e28`](https://github.com/Twingate/kubernetes-operator/commit/6971e28a421dc5ae6d821465d0d6e5f99f6b0156))

- Add `remoteNetworkId` to TwingateGateway CRD
  ([#1109](https://github.com/Twingate/kubernetes-operator/pull/1109),
  [`a3132a0`](https://github.com/Twingate/kubernetes-operator/commit/a3132a01c49d69d85542c0a0ba2f0119c9faec58))

- Add `WebApp` resource type support and k8s service annotation
  ([#1052](https://github.com/Twingate/kubernetes-operator/pull/1052),
  [`727f03b`](https://github.com/Twingate/kubernetes-operator/commit/727f03baf004ab1fef653248c0ba37607ec7f53a))

- Add remoteNetworkId to TwingateResource and TwingateConnector CRDs
  ([#1094](https://github.com/Twingate/kubernetes-operator/pull/1094),
  [`72da8fd`](https://github.com/Twingate/kubernetes-operator/commit/72da8fd99300c9aa8902ac1f8d148aff32652f1a))

- Change license to Apache 2.0 ([#1125](https://github.com/Twingate/kubernetes-operator/pull/1125),
  [`ae3afa3`](https://github.com/Twingate/kubernetes-operator/commit/ae3afa37d6524780f1a4c9816a7ab1d2f650a3d8))

- Default object-reference `namespace` to the CR's own `namespace`
  ([#1101](https://github.com/Twingate/kubernetes-operator/pull/1101),
  [`7cc44c3`](https://github.com/Twingate/kubernetes-operator/commit/7cc44c37c5d2e4f5a57e2f8bfe7782880a978185))

- Keep the Kubernetes Resource when the Service annotation is removed
  ([`f92c1f9`](https://github.com/Twingate/kubernetes-operator/commit/f92c1f9d4c4bf16dfc5f0ef06b3118b34ae3cad3))

- Reconcile `TwingateResourceAccess` when the referenced resource or principal ID changes
  ([#1104](https://github.com/Twingate/kubernetes-operator/pull/1104),
  [`a74a907`](https://github.com/Twingate/kubernetes-operator/commit/a74a90725195f01ff1bf6a568abdd95ca940fea0))

- Remove deprecated `twingate.com/resource` Service annotation
  ([#1090](https://github.com/Twingate/kubernetes-operator/pull/1090),
  [`a7703b7`](https://github.com/Twingate/kubernetes-operator/commit/a7703b711231436d5682207a5c9462d67c64179b))

- Remove deprecated Kubernetes support
  ([#1084](https://github.com/Twingate/kubernetes-operator/pull/1084),
  [`c9999c1`](https://github.com/Twingate/kubernetes-operator/commit/c9999c1d4d78d7859595f6170ada3905d78a6c27))

- Repair Kubernetes Resources left behind by the v2 upgrade
  ([#1112](https://github.com/Twingate/kubernetes-operator/pull/1112),
  [`5f95198`](https://github.com/Twingate/kubernetes-operator/commit/5f951982d56955640166e72ff580277795a75fea))

- Support `requestHeaderRewrites` for `WebApp` resources
  ([#1083](https://github.com/Twingate/kubernetes-operator/pull/1083),
  [`3a39c75`](https://github.com/Twingate/kubernetes-operator/commit/3a39c7509d02a475383d45adb329d75296837e42))

- Support `TwingateGateway` and `TwingateCertificateAuthority` custom resources
  ([#1038](https://github.com/Twingate/kubernetes-operator/pull/1038),
  [`c7bf978`](https://github.com/Twingate/kubernetes-operator/commit/c7bf97821128f56f14a65e81d3f8a8c108f00345))

### Testing

- Fix flaky teardown in `test_gateway_flows`
...
- Bump actions/checkout from 6.0.2 to 6.0.3
  ([#1020](https://github.com/Twingate/kubernetes-operator/pull/1020),
  [`e02ece7`](https://github.com/Twingate/kubernetes-operator/commit/e02ece74524b93d6af43c5257d10ae51e9e67629))

- Bump actions/stale from 10.2.0 to 10.3.0
  ([#1008](https://github.com/Twingate/kubernetes-operator/pull/1008),
  [`ed63639`](https://github.com/Twingate/kubernetes-operator/commit/ed63639ef160131dc78b1028ca3e76492e13480d))

- Bump codecov/codecov-action from 6.0.0 to 6.0.1
  ([#1006](https://github.com/Twingate/kubernetes-operator/pull/1006),
  [`fa6e2d5`](https://github.com/Twingate/kubernetes-operator/commit/fa6e2d50edd1c7df3b6d4ba9f44f89df90c92632))

- Bump codecov/codecov-action from 6.0.1 to 7.0.0
  ([#1024](https://github.com/Twingate/kubernetes-operator/pull/1024),
  [`54d3bd8`](https://github.com/Twingate/kubernetes-operator/commit/54d3bd8fb4f09ef35f8e0ef51b2bebb8d1bee874))

- Bump docker/login-action from 4.1.0 to 4.2.0
  ([#1013](https://github.com/Twingate/kubernetes-operator/pull/1013),
  [`7bed4bf`](https://github.com/Twingate/kubernetes-operator/commit/7bed4bf96881efc68711a279d0935057831fc949))

- Bump docker/setup-buildx-action from 4.0.0 to 4.1.0
  ([#1012](https://github.com/Twingate/kubernetes-operator/pull/1012),
  [`79ac234`](https://github.com/Twingate/kubernetes-operator/commit/79ac2349e8cac959794baeb3920115db0e35d774))

- Bump docker/setup-qemu-action from 4.0.0 to 4.1.0
  ([#1015](https://github.com/Twingate/kubernetes-operator/pull/1015),
  [`485e467`](https://github.com/Twingate/kubernetes-operator/commit/485e46767bb78d5373a8d8c03f1930d5c42b5fae))

- Bump google-cloud-artifact-registry from 1.21.0 to 1.22.0
  ([#1022](https://github.com/Twingate/kubernetes-operator/pull/1022),
  [`157ae9a`](https://github.com/Twingate/kubernetes-operator/commit/157ae9a1f981a2d1d1c6fc324e154963caf851ed))

- Bump idna from 3.7 to 3.15 ([#1007](https://github.com/Twingate/kubernetes-operator/pull/1007),
  [`3c9fc53`](https://github.com/Twingate/kubernetes-operator/commit/3c9fc53f057fbe32a98163f2b738aee5617d1f67))

- Bump responses from 0.26.0 to 0.26.1
  ([#1010](https://github.com/Twingate/kubernetes-operator/pull/1010),
  [`2d8a4b0`](https://github.com/Twingate/kubernetes-operator/commit/2d8a4b0a53bc5e402dfd025a6b475c3aa0b6c2c9))

- Bump ruff from 0.15.13 to 0.15.14
  ([#1011](https://github.com/Twingate/kubernetes-operator/pull/1011),
  [`c1925cf`](https://github.com/Twingate/kubernetes-operator/commit/c1925cfaf40d762755eb93e317d7ad9206669f8d))

- Bump ruff from 0.15.14 to 0.15.15
  ([#1016](https://github.com/Twingate/kubernetes-operator/pull/1016),
  [`73637d1`](https://github.com/Twingate/kubernetes-operator/commit/73637d1d727eca32cd8e3917bcb8caf91b09dad2))

- Bump ruff from 0.15.15 to 0.15.16
  ([#1023](https://github.com/Twingate/kubernetes-operator/pull/1023),
  [`b1524be`](https://github.com/Twingate/kubernetes-operator/commit/b1524bea92ac5a583a0595557d1be44a74af82bb))

- Bump snok/install-poetry from 1.4.1 to 1.4.2
  ([#1017](https://github.com/Twingate/kubernetes-operator/pull/1017),
  [`031dcc7`](https://github.com/Twingate/kubernetes-operator/commit/031dcc7bf23582f4751ef53b75e9cab710961fe1))

- Bump syrupy from 5.1.0 to 5.2.0
  ([#1005](https://github.com/Twingate/kubernetes-operator/pull/1005),
  [`3640700`](https://github.com/Twingate/kubernetes-operator/commit/36407000169f300967e23bd32a0a96e542e55249))

- Bump syrupy from 5.2.0 to 5.3.1
  ([#1018](https://github.com/Twingate/kubernetes-operator/pull/1018),
  [`29ee12e`](https://github.com/Twingate/kubernetes-operator/commit/29ee12eefda1d97ffe4c8e7754aaf7e69cfc91a3))

- Bump types-croniter from 6.2.2.20260508 to 6.2.2.20260518
  ([#1002](https://github.com/Twingate/kubernetes-operator/pull/1002),
  [`aaf0e7a`](https://github.com/Twingate/kubernetes-operator/commit/aaf0e7a5488521c8df5ce142da47baafd0a1930b))

- Bump types-pyyaml from 6.0.12.20260510 to 6.0.12.20260518
  ([#1004](https://github.com/Twingate/kubernetes-operator/pull/1004),
  [`3a6d9de`](https://github.com/Twingate/kubernetes-operator/commit/3a6d9de016553605523fe35a29e1176049fce5b7))

- Bump types-requests from 2.33.0.20260513 to 2.33.0.20260518
  ([#1003](https://github.com/Twingate/kubernetes-operator/pull/1003),
  [`e776771`](https://github.com/Twingate/kubernetes-operator/commit/e776771f2db783c12e4d8748b8d660ab4730caad))

- Update poetry on .tool-versions
  ([`86a9f6f`](https://github.com/Twingate/kubernetes-operator/commit/86a9f6fba914a66709690564bcf3b1cf6e8c2dd6))

- Upgrade Poetry from 2.2.1 to 2.4.1
  ([#1028](https://github.com/Twingate/kubernetes-operator/pull/1028),
  [`84e39bb`](https://github.com/Twingate/kubernetes-operator/commit/84e39bbcace5d5ac71222b21e1bce15da4962ff9))

- Upgrade Python from 3.12.12 to 3.12.13
  ([#1026](https://github.com/Twingate/kubernetes-operator/pull/1026),
  [`d56599a`](https://github.com/Twingate/kubernetes-operator/commit/d56599a62c110728297c1b2dcade8f7a28988d05))

### Features

- Resolve shard URL at Operator startup
  ([#998](https://github.com/Twingate/kubernetes-operator/pull/998),
  [`88da60c`](https://github.com/Twingate/kubernetes-operator/commit/88da60cbea16b074daa0ed57446f035ad870f15c))

- Support full AccessInput in resource access API
...
- Bump gateway from 0.16.0 to 0.17.0 in /deploy/twingate-operator
  ([#1001](https://github.com/Twingate/kubernetes-operator/pull/1001),
  [`30899ab`](https://github.com/Twingate/kubernetes-operator/commit/30899ab3a4798fee5122600d6b1a75cac1279111))

- Bump gitpython from 3.1.47 to 3.1.49
  ([#984](https://github.com/Twingate/kubernetes-operator/pull/984),
  [`bcf74bd`](https://github.com/Twingate/kubernetes-operator/commit/bcf74bd73b5b42ee890c408e3da1394a449093b3))

- Bump gitpython from 3.1.49 to 3.1.50
  ([#988](https://github.com/Twingate/kubernetes-operator/pull/988),
  [`5bdb0dd`](https://github.com/Twingate/kubernetes-operator/commit/5bdb0dd8be42ceb48c1126d4e03862696488f350))

- Bump mypy from 1.20.2 to 2.1.0 ([#991](https://github.com/Twingate/kubernetes-operator/pull/991),
  [`1f75b40`](https://github.com/Twingate/kubernetes-operator/commit/1f75b40e735783955e0afeab24bbf0b296dac78a))

- Bump orjson from 3.11.8 to 3.11.9
  ([#983](https://github.com/Twingate/kubernetes-operator/pull/983),
  [`1534d8f`](https://github.com/Twingate/kubernetes-operator/commit/1534d8f63908aba1f57703b702347b661a3e902e))

- Bump pydantic from 2.13.3 to 2.13.4
  ([#982](https://github.com/Twingate/kubernetes-operator/pull/982),
  [`7b81628`](https://github.com/Twingate/kubernetes-operator/commit/7b81628dd2d9beddc494ca278a7dbbf53e663bec))

- Bump pydantic-settings from 2.14.0 to 2.14.1
  ([#990](https://github.com/Twingate/kubernetes-operator/pull/990),
  [`0e416db`](https://github.com/Twingate/kubernetes-operator/commit/0e416dbcf6e2bf29f27edb8b88f5217301601858))

- Bump requests from 2.33.1 to 2.34.0
  ([#993](https://github.com/Twingate/kubernetes-operator/pull/993),
  [`ded5277`](https://github.com/Twingate/kubernetes-operator/commit/ded5277148eb9a99a9254c6363287c65e5779e9f))

- Bump requests from 2.34.0 to 2.34.1
  ([#996](https://github.com/Twingate/kubernetes-operator/pull/996),
  [`5eca080`](https://github.com/Twingate/kubernetes-operator/commit/5eca080a2c4685bd02db9d27770ddae7588df386))

- Bump requests from 2.34.1 to 2.34.2
  ([#1000](https://github.com/Twingate/kubernetes-operator/pull/1000),
  [`b022d47`](https://github.com/Twingate/kubernetes-operator/commit/b022d470266a57f54c86f8550b5d1c0e4f928bf9))

- Bump ruff from 0.15.12 to 0.15.13
  ([#999](https://github.com/Twingate/kubernetes-operator/pull/999),
  [`b33f441`](https://github.com/Twingate/kubernetes-operator/commit/b33f441f0e6da7e6952f3075091e80ef20f2fb3a))

- Bump types-croniter from 6.2.2.20260408 to 6.2.2.20260508
  ([#987](https://github.com/Twingate/kubernetes-operator/pull/987),
  [`82ea745`](https://github.com/Twingate/kubernetes-operator/commit/82ea745af0a51027fb20d697093c7a1169586f5f))

- Bump types-pyyaml from 6.0.12.20260408 to 6.0.12.20260508
  ([#986](https://github.com/Twingate/kubernetes-operator/pull/986),
  [`037e18f`](https://github.com/Twingate/kubernetes-operator/commit/037e18f08d3289dd72f15bcde86670b0b840413f))

- Bump types-pyyaml from 6.0.12.20260508 to 6.0.12.20260510
  ([#992](https://github.com/Twingate/kubernetes-operator/pull/992),
  [`6738bbc`](https://github.com/Twingate/kubernetes-operator/commit/6738bbc531576a16586e64258454894fd6297050))

- Bump types-requests from 2.33.0.20260503 to 2.33.0.20260508
  ([#985](https://github.com/Twingate/kubernetes-operator/pull/985),
  [`a611cdb`](https://github.com/Twingate/kubernetes-operator/commit/a611cdb0aed908c1e123caa286466ae9bd87159c))

- Bump types-requests from 2.33.0.20260508 to 2.33.0.20260513
  ([#995](https://github.com/Twingate/kubernetes-operator/pull/995),
  [`79e45ed`](https://github.com/Twingate/kubernetes-operator/commit/79e45edbb8ffb232f2cf93cd26cad0348518546c))
...
- Retry TwingateResourceAccess quickly when referenced TwingateResource is missing (#904)
  ([#979](https://github.com/Twingate/kubernetes-operator/pull/979),
  [`6005238`](https://github.com/Twingate/kubernetes-operator/commit/60052382da1fa0a632e6faa663c6ac054a9d318f))

- Revert Gateway Helm subchart upgrade
  ([#920](https://github.com/Twingate/kubernetes-operator/pull/920),
  [`a77e913`](https://github.com/Twingate/kubernetes-operator/commit/a77e9133511e8f04fe7401b06bd0c553ef29499e))

- Update Helm test snapshots ([#919](https://github.com/Twingate/kubernetes-operator/pull/919),
  [`9790be6`](https://github.com/Twingate/kubernetes-operator/commit/9790be609911f180c7b0b88a09e0f5e34ac19a9d))

### Chores

- Bump actions/cache from 5.0.4 to 5.0.5
  ([#959](https://github.com/Twingate/kubernetes-operator/pull/959),
  [`0b51560`](https://github.com/Twingate/kubernetes-operator/commit/0b51560b45c42180eb5da236c5535c6547a2c4ef))

- Bump aiohttp from 3.13.3 to 3.13.4
  ([#941](https://github.com/Twingate/kubernetes-operator/pull/941),
  [`e0f2572`](https://github.com/Twingate/kubernetes-operator/commit/e0f2572b85feecd6dd928294ca9b060c8c8f67d6))

- Bump azure/setup-helm from 4 to 5
  ([#924](https://github.com/Twingate/kubernetes-operator/pull/924),
  [`ccd750d`](https://github.com/Twingate/kubernetes-operator/commit/ccd750ddb85d388dfa98457c2e2cd6437a5adc4d))

- Bump codecov/codecov-action from 5 to 6
  ([#928](https://github.com/Twingate/kubernetes-operator/pull/928),
  [`2a1e2ec`](https://github.com/Twingate/kubernetes-operator/commit/2a1e2ec0b80f56720851677a6b1d1ffd54393d78))

- Bump cryptography from 46.0.5 to 46.0.6
  ([#927](https://github.com/Twingate/kubernetes-operator/pull/927),
  [`af45ecf`](https://github.com/Twingate/kubernetes-operator/commit/af45ecf8b9efb0c8e0138d503b54a51fe695ad92))

- Bump cryptography from 46.0.6 to 46.0.7
  ([#950](https://github.com/Twingate/kubernetes-operator/pull/950),
  [`189add2`](https://github.com/Twingate/kubernetes-operator/commit/189add2db4455c2162d2ca6a8b96e0f5b8017762))

- Bump cryptography from 46.0.7 to 47.0.0
  ([#974](https://github.com/Twingate/kubernetes-operator/pull/974),
  [`6b1de62`](https://github.com/Twingate/kubernetes-operator/commit/6b1de62c1e6d22397173aefd477283c71d733d1e))

- Bump cryptography from 47.0.0 to 48.0.0
  ([#978](https://github.com/Twingate/kubernetes-operator/pull/978),
  [`b6678d5`](https://github.com/Twingate/kubernetes-operator/commit/b6678d5fab23eaeed54c3161abfabda341b04908))

- Bump dependabot/fetch-metadata from 3.0.0 to 3.1.0
  ([#963](https://github.com/Twingate/kubernetes-operator/pull/963),
  [`f36c787`](https://github.com/Twingate/kubernetes-operator/commit/f36c787fd9da0aa434803eee51b214523a16d30c))

- Bump docker/login-action from 4.0.0 to 4.1.0
  ([#947](https://github.com/Twingate/kubernetes-operator/pull/947),
  [`df283b6`](https://github.com/Twingate/kubernetes-operator/commit/df283b63f713a28290207d9ed06bfb4bb38e4094))

- Bump gateway from 0.13.0 to 0.14.0 in /deploy/twingate-operator
  ([#975](https://github.com/Twingate/kubernetes-operator/pull/975),
  [`452d5ea`](https://github.com/Twingate/kubernetes-operator/commit/452d5ea7611a75adfbab3e9927a4e73dd4f92b19))

- Bump gateway from 0.14.0 to 0.15.0 in /deploy/twingate-operator
  ([#976](https://github.com/Twingate/kubernetes-operator/pull/976),
  [`9ea2882`](https://github.com/Twingate/kubernetes-operator/commit/9ea28827380f36461aaf3b3f4ccbb2a501d3687d))

- Bump gitpython from 3.1.41 to 3.1.47
  ([#972](https://github.com/Twingate/kubernetes-operator/pull/972),
  [`4c82b1d`](https://github.com/Twingate/kubernetes-operator/commit/4c82b1d89148af27805acc2d9e7eecd32e02d8a9))

- Bump google-cloud-artifact-registry from 1.20.0 to 1.21.0
  ([#933](https://github.com/Twingate/kubernetes-operator/pull/933),
  [`e800649`](https://github.com/Twingate/kubernetes-operator/commit/e8006493d05bbd8ccc53c3c10525264ca6723b6e))

- Bump kubernetes-access-gateway from 0.11.1 to 0.12.0 in /deploy/twingate-operator
  ([#918](https://github.com/Twingate/kubernetes-operator/pull/918),
  [`ca04551`](https://github.com/Twingate/kubernetes-operator/commit/ca04551ad7df2902174ce9e05215905a07626232))

- Bump kubernetes-access-gateway from 0.11.1 to 0.12.1 in /deploy/twingate-operator
  ([#922](https://github.com/Twingate/kubernetes-operator/pull/922),
  [`545156e`](https://github.com/Twingate/kubernetes-operator/commit/545156e744b38740944db89d49a079909d38526b))

- Bump mypy from 1.19.1 to 1.20.0 ([#938](https://github.com/Twingate/kubernetes-operator/pull/938),
  [`e780895`](https://github.com/Twingate/kubernetes-operator/commit/e7808958b4fd5eb44abe99d6990b54073d09aa8d))

- Bump mypy from 1.20.0 to 1.20.1 ([#958](https://github.com/Twingate/kubernetes-operator/pull/958),
  [`990aeaf`](https://github.com/Twingate/kubernetes-operator/commit/990aeafbdf956d46decf01bcee252c890049c8a4))

- Bump mypy from 1.20.1 to 1.20.2 ([#971](https://github.com/Twingate/kubernetes-operator/pull/971),
  [`5482388`](https://github.com/Twingate/kubernetes-operator/commit/548238870dda353766855cabe0691e6fe323add2))

- Bump orjson from 3.11.7 to 3.11.8
  ([#937](https://github.com/Twingate/kubernetes-operator/pull/937),
  [`58d76f7`](https://github.com/Twingate/kubernetes-operator/commit/58d76f73212e3824d652e9d3c50ca0d33a9d82aa))

- Bump pre-commit from 4.5.1 to 4.6.0
  ([#970](https://github.com/Twingate/kubernetes-operator/pull/970),
  [`88468ce`](https://github.com/Twingate/kubernetes-operator/commit/88468ce03793a1cb87b9651d987fdff48ac90a94))

- Bump pyasn1 from 0.5.0 to 0.6.3 ([#917](https://github.com/Twingate/kubernetes-operator/pull/917),
  [`931a8ac`](https://github.com/Twingate/kubernetes-operator/commit/931a8ac63640d91a51a6c63e4cee470fd8cdfe80))

- Bump pydantic from 2.12.5 to 2.13.1
  ([#960](https://github.com/Twingate/kubernetes-operator/pull/960),
  [`c2e8100`](https://github.com/Twingate/kubernetes-operator/commit/c2e810050ec8e07cb07be17ecdbdf01123d2ccbe))

- Bump pydantic from 2.13.1 to 2.13.2
  ([#962](https://github.com/Twingate/kubernetes-operator/pull/962),
  [`a2e1be2`](https://github.com/Twingate/kubernetes-operator/commit/a2e1be23baa9e5413c54237d4068201f8a690d24))

- Bump pydantic from 2.13.2 to 2.13.3
  ([#967](https://github.com/Twingate/kubernetes-operator/pull/967),
  [`a225a0e`](https://github.com/Twingate/kubernetes-operator/commit/a225a0e3b5942d3aa97241798dc256da7b7d7e2d))

- Bump pydantic-settings from 2.13.1 to 2.14.0
  ([#966](https://github.com/Twingate/kubernetes-operator/pull/966),
  [`2ef9d56`](https://github.com/Twingate/kubernetes-operator/commit/2ef9d5658fd2909a3e483a7ae42376b3717d7e9c))

- Bump pygments from 2.16.1 to 2.20.0
  ([#932](https://github.com/Twingate/kubernetes-operator/pull/932),
  [`6b1597a`](https://github.com/Twingate/kubernetes-operator/commit/6b1597a17d32a4e1224b1275cce310430d73946e))

- Bump pytest from 9.0.2 to 9.0.3 ([#952](https://github.com/Twingate/kubernetes-operator/pull/952),
  [`cd9ede9`](https://github.com/Twingate/kubernetes-operator/commit/cd9ede9b17a2d61f9a4cfdc6f96e48f7f9d1e5ce))

- Bump pytest-cov from 7.0.0 to 7.1.0
  ([#923](https://github.com/Twingate/kubernetes-operator/pull/923),
  [`e491710`](https://github.com/Twingate/kubernetes-operator/commit/e491710abb7337aec018c505af7eafebdca260f0))

- Bump pytest-randomly from 4.0.1 to 4.1.0
  ([#968](https://github.com/Twingate/kubernetes-operator/pull/968),
  [`e0f6235`](https://github.com/Twingate/kubernetes-operator/commit/e0f62352ddebdee4317391e5d8f5984e2ee989eb))

- Bump python-dotenv from 1.0.0 to 1.2.2
  ([#969](https://github.com/Twingate/kubernetes-operator/pull/969),
  [`6ebcd45`](https://github.com/Twingate/kubernetes-operator/commit/6ebcd459ffae4a9933d0666b894eca8ed67d2ffb))

- Bump requarks/changelog-action from 1.10.2 to 1.10.3
  ([#942](https://github.com/Twingate/kubernetes-operator/pull/942),
  [`59ac763`](https://github.com/Twingate/kubernetes-operator/commit/59ac763683cf28bc49166131a8ae08eb12ba8b0a))

- Bump requests from 2.32.5 to 2.33.0
  ([#926](https://github.com/Twingate/kubernetes-operator/pull/926),
  [`a0541fe`](https://github.com/Twingate/kubernetes-operator/commit/a0541fe4471b16d7622d2a4beaad8cee5170c2bc))

- Bump requests from 2.33.0 to 2.33.1
  ([#934](https://github.com/Twingate/kubernetes-operator/pull/934),
  [`ca9f8d1`](https://github.com/Twingate/kubernetes-operator/commit/ca9f8d102d76adb3baf4b32a772d6ab659a18351))

- Bump ruff from 0.15.10 to 0.15.11
  ([#961](https://github.com/Twingate/kubernetes-operator/pull/961),
  [`252b0e7`](https://github.com/Twingate/kubernetes-operator/commit/252b0e7b59a60dcbcbab14433a76ad70325955e6))

- Bump ruff from 0.15.11 to 0.15.12
  ([#973](https://github.com/Twingate/kubernetes-operator/pull/973),
  [`2ecec34`](https://github.com/Twingate/kubernetes-operator/commit/2ecec34fb4b0dd7fcb893711d2daa4dd5cbde8ec))

- Bump ruff from 0.15.6 to 0.15.7 ([#921](https://github.com/Twingate/kubernetes-operator/pull/921),
  [`5dcd6b5`](https://github.com/Twingate/kubernetes-operator/commit/5dcd6b5490ddee8505a6f8df564baf87de85dabd))

- Bump ruff from 0.15.7 to 0.15.8 ([#929](https://github.com/Twingate/kubernetes-operator/pull/929),
  [`63c52cc`](https://github.com/Twingate/kubernetes-operator/commit/63c52cc8486cef2efe6c2104bf8924c9666559d3))

- Bump ruff from 0.15.8 to 0.15.9 ([#948](https://github.com/Twingate/kubernetes-operator/pull/948),
  [`3331bff`](https://github.com/Twingate/kubernetes-operator/commit/3331bff717a41344b92743277240d7269b430a0d))

- Bump ruff from 0.15.9 to 0.15.10
  ([#955](https://github.com/Twingate/kubernetes-operator/pull/955),
  [`5d3bdeb`](https://github.com/Twingate/kubernetes-operator/commit/5d3bdebd9bc5ae800bcf483d3d41c57647b6b797))

- Bump types-croniter from 6.2.2.20260316 to 6.2.2.20260402
  ([#944](https://github.com/Twingate/kubernetes-operator/pull/944),
  [`0bd8f1d`](https://github.com/Twingate/kubernetes-operator/commit/0bd8f1d10a22baed33d370a309bb40fb07b68234))

- Bump types-croniter from 6.2.2.20260402 to 6.2.2.20260408
  ([#954](https://github.com/Twingate/kubernetes-operator/pull/954),
  [`560507b`](https://github.com/Twingate/kubernetes-operator/commit/560507be852cb5debd7303d0e3327fe6d3528c11))

- Bump types-pyyaml from 6.0.12.20250915 to 6.0.12.20260408
  ([#951](https://github.com/Twingate/kubernetes-operator/pull/951),
  [`db5c9b4`](https://github.com/Twingate/kubernetes-operator/commit/db5c9b48c88fa0ae4def35ecef322a2eb2664540))

- Bump types-requests from 2.32.4.20260107 to 2.32.4.20260324
  ([#925](https://github.com/Twingate/kubernetes-operator/pull/925),
  [`c704e93`](https://github.com/Twingate/kubernetes-operator/commit/c704e9355c5b703dc1ef3370ae6d60b32dfebd54))

- Bump types-requests from 2.32.4.20260324 to 2.33.0.20260327
  ([#930](https://github.com/Twingate/kubernetes-operator/pull/930),
  [`72ff589`](https://github.com/Twingate/kubernetes-operator/commit/72ff5892ed47caedaac35a476d0cfaeff7dc2302))

- Bump types-requests from 2.33.0.20260327 to 2.33.0.20260402
  ([#943](https://github.com/Twingate/kubernetes-operator/pull/943),
  [`c11710d`](https://github.com/Twingate/kubernetes-operator/commit/c11710d4bc6d3dfe18668cf3d9e450cb02c4e644))

- Bump types-requests from 2.33.0.20260402 to 2.33.0.20260408
  ([#953](https://github.com/Twingate/kubernetes-operator/pull/953),
  [`9582c7f`](https://github.com/Twingate/kubernetes-operator/commit/9582c7f707f772b5410eec0ce9f7b23432127e21))

- Bump types-requests from 2.33.0.20260408 to 2.33.0.20260503
  ([#977](https://github.com/Twingate/kubernetes-operator/pull/977),
  [`b0c0ebe`](https://github.com/Twingate/kubernetes-operator/commit/b0c0ebebf4e1b9a381ed50856d6cf597c5c29f7c))

- Fix flaky connector flow integration test
  ([#964](https://github.com/Twingate/kubernetes-operator/pull/964),
  [`c3c525e`](https://github.com/Twingate/kubernetes-operator/commit/c3c525ea98ac22356d837b468779ce170df41688))

- Pin Github action versions using commit SHA
  ([#936](https://github.com/Twingate/kubernetes-operator/pull/936),
  [`2c2fc1d`](https://github.com/Twingate/kubernetes-operator/commit/2c2fc1dd8677959de9987f20c26b34e3eaf9bc66))

### Features

- Add status printer columns to TwingateResourceAccess CRD
  ([#931](https://github.com/Twingate/kubernetes-operator/pull/931),
  [`ef7e8a3`](https://github.com/Twingate/kubernetes-operator/commit/ef7e8a3bd4009780d88ba48af08323423ea2da62))

- Update `kubernetes-access-gateway` Helm sub chart to `gateway`
  ([#946](https://github.com/Twingate/kubernetes-operator/pull/946),
  [`24903b3`](https://github.com/Twingate/kubernetes-operator/commit/24903b3d44f0782c748fd364f209972e83e956f0))

- **chart**: Allow livenessProbe/readinessProbe tuning via values
...
- Make CodeCov verbose
  ([`952de8a`](https://github.com/Twingate/kubernetes-operator/commit/952de8a3cafc7f9cb04c9d08948d95f98fcdfcb0))

### Chores

- Add tests for `twingate_service_annotation_removed` handler
  ([#907](https://github.com/Twingate/kubernetes-operator/pull/907),
  [`2f1ebe7`](https://github.com/Twingate/kubernetes-operator/commit/2f1ebe71b639f0c6aeac6467a1ce28fc2483c234))

- Bump bandit from 1.9.3 to 1.9.4 ([#897](https://github.com/Twingate/kubernetes-operator/pull/897),
  [`326957e`](https://github.com/Twingate/kubernetes-operator/commit/326957e10ce4be4cc2e7a3beec281a0bf0839abb))

- Bump crazy-max/ghaction-github-runtime from 3 to 4
  ([#903](https://github.com/Twingate/kubernetes-operator/pull/903),
  [`e407d33`](https://github.com/Twingate/kubernetes-operator/commit/e407d3311d51e764847c43fce49c7377a17c62c8))

- Bump croniter from 6.0.0 to 6.2.2
  ([#915](https://github.com/Twingate/kubernetes-operator/pull/915),
  [`b7b558c`](https://github.com/Twingate/kubernetes-operator/commit/b7b558c51410dcaad50df487c4e92d07934af195))

- Bump cryptography from 46.0.3 to 46.0.4
  ([#878](https://github.com/Twingate/kubernetes-operator/pull/878),
  [`9b0617f`](https://github.com/Twingate/kubernetes-operator/commit/9b0617fbc4c81f7ed237ef5ef3a2d6fb7028857c))

- Bump cryptography from 46.0.4 to 46.0.5
  ([#886](https://github.com/Twingate/kubernetes-operator/pull/886),
  [`67f5ca3`](https://github.com/Twingate/kubernetes-operator/commit/67f5ca33cd381da8487954021ab868120b7f61c3))

- Bump docker/login-action from 3 to 4
  ([#905](https://github.com/Twingate/kubernetes-operator/pull/905),
  [`a210444`](https://github.com/Twingate/kubernetes-operator/commit/a2104448a0ece7ba3f916ad809bda50f62d1c892))

- Bump docker/setup-buildx-action from 3 to 4
  ([#908](https://github.com/Twingate/kubernetes-operator/pull/908),
  [`ce852dc`](https://github.com/Twingate/kubernetes-operator/commit/ce852dce8cf4e3643d4d94f0d1f2aa898136b0e2))

- Bump docker/setup-qemu-action from 3 to 4
  ([#906](https://github.com/Twingate/kubernetes-operator/pull/906),
  [`7134714`](https://github.com/Twingate/kubernetes-operator/commit/713471452e83a205c5f47e3872113a92cbfd1b5b))

- Bump google-cloud-artifact-registry from 1.19.0 to 1.20.0
  ([#887](https://github.com/Twingate/kubernetes-operator/pull/887),
  [`a98c968`](https://github.com/Twingate/kubernetes-operator/commit/a98c968ba1d578a3c902730ea8dd76b7145dbd6c))

- Bump ncipollo/release-action from 1.20.0 to 1.21.0
  ([#914](https://github.com/Twingate/kubernetes-operator/pull/914),
  [`956b729`](https://github.com/Twingate/kubernetes-operator/commit/956b729d9fa3e075c7fae691731d7f358f682fd5))

- Bump orjson from 3.11.5 to 3.11.6
  ([#880](https://github.com/Twingate/kubernetes-operator/pull/880),
  [`6d10578`](https://github.com/Twingate/kubernetes-operator/commit/6d10578bc30e1e851de632289161f5d7b98cbf86))

- Bump orjson from 3.11.6 to 3.11.7
  ([#881](https://github.com/Twingate/kubernetes-operator/pull/881),
  [`4c7cfa1`](https://github.com/Twingate/kubernetes-operator/commit/4c7cfa1565434c88163d0f2b5cd8911958332fcc))

- Bump pendulum from 3.1.0 to 3.2.0
  ([#879](https://github.com/Twingate/kubernetes-operator/pull/879),
  [`84697f2`](https://github.com/Twingate/kubernetes-operator/commit/84697f21f1b5759fadc685c21835df800fc91c23))

- Bump protobuf from 4.25.8 to 6.33.5
  ([#882](https://github.com/Twingate/kubernetes-operator/pull/882),
  [`ee8e761`](https://github.com/Twingate/kubernetes-operator/commit/ee8e761f93f59bc0935f2766f5a90752c7490fa9))

- Bump pydantic-settings from 2.12.0 to 2.13.0
  ([#892](https://github.com/Twingate/kubernetes-operator/pull/892),
  [`993db5f`](https://github.com/Twingate/kubernetes-operator/commit/993db5fd76b9c31f44f58368b4b4bedea4fdbf79))

- Bump pydantic-settings from 2.13.0 to 2.13.1
  ([#896](https://github.com/Twingate/kubernetes-operator/pull/896),
  [`c1cb97d`](https://github.com/Twingate/kubernetes-operator/commit/c1cb97d5facf9a93c33cadba865b37b12627896c))

- Bump responses from 0.25.8 to 0.26.0
  ([#894](https://github.com/Twingate/kubernetes-operator/pull/894),
  [`68a3066`](https://github.com/Twingate/kubernetes-operator/commit/68a3066a94966b8b3ec5d8ee7a61363212c2737b))

- Bump ruff from 0.14.13 to 0.14.14
  ([#876](https://github.com/Twingate/kubernetes-operator/pull/876),
  [`db253a1`](https://github.com/Twingate/kubernetes-operator/commit/db253a1dd86e8fa313aa7060fac92b4ba140fdd9))

- Bump ruff from 0.14.14 to 0.15.0
  ([#883](https://github.com/Twingate/kubernetes-operator/pull/883),
  [`e1b8dd0`](https://github.com/Twingate/kubernetes-operator/commit/e1b8dd05efa393c5e1c950e940961f99ae8afbf9))

- Bump ruff from 0.15.0 to 0.15.1 ([#888](https://github.com/Twingate/kubernetes-operator/pull/888),
  [`8379a57`](https://github.com/Twingate/kubernetes-operator/commit/8379a575954b6a8c24e9ceb652f798ce9d5c1a66))

- Bump ruff from 0.15.1 to 0.15.2 ([#895](https://github.com/Twingate/kubernetes-operator/pull/895),
  [`02d2a99`](https://github.com/Twingate/kubernetes-operator/commit/02d2a9977f868f26258023b2e7a532bee1fead0f))

- Bump ruff from 0.15.2 to 0.15.4 ([#902](https://github.com/Twingate/kubernetes-operator/pull/902),
  [`b153ccc`](https://github.com/Twingate/kubernetes-operator/commit/b153ccc3d119f8d970224181f07fc584d43fc50e))

- Bump ruff from 0.15.4 to 0.15.5 ([#910](https://github.com/Twingate/kubernetes-operator/pull/910),
  [`514191a`](https://github.com/Twingate/kubernetes-operator/commit/514191abb86a8f561dc536ee2df297a9ffe25d93))

- Bump ruff from 0.15.5 to 0.15.6 ([#912](https://github.com/Twingate/kubernetes-operator/pull/912),
  [`207060f`](https://github.com/Twingate/kubernetes-operator/commit/207060fc325771419e168d6381b3368c2490151d))

- Bump syrupy from 5.0.0 to 5.1.0 ([#877](https://github.com/Twingate/kubernetes-operator/pull/877),
  [`ea26ae7`](https://github.com/Twingate/kubernetes-operator/commit/ea26ae7615a1cfd4769be7dad712e9b455c6348a))

- Bump tenacity from 9.1.2 to 9.1.3
  ([#884](https://github.com/Twingate/kubernetes-operator/pull/884),
  [`a926240`](https://github.com/Twingate/kubernetes-operator/commit/a9262409d76d545b4673b6c021638600f7f1ab7e))

- Bump tenacity from 9.1.3 to 9.1.4
  ([#885](https://github.com/Twingate/kubernetes-operator/pull/885),
  [`f71dc52`](https://github.com/Twingate/kubernetes-operator/commit/f71dc522477bc64c3a32e24745b8d714b2beecf6))

- Bump types-croniter from 6.0.0.20250809 to 6.2.2.20260316
  ([#916](https://github.com/Twingate/kubernetes-operator/pull/916),
  [`bd334bf`](https://github.com/Twingate/kubernetes-operator/commit/bd334bf7ef40735bffe501c85257ee7dc9e522ef))

- CodeCov test results ([#900](https://github.com/Twingate/kubernetes-operator/pull/900),
  [`c0a43a8`](https://github.com/Twingate/kubernetes-operator/commit/c0a43a89ac2b2874f04c1699b05032e390c2f1a8))

- Enable branch coverage on make test-cov
  ([`2c4db2d`](https://github.com/Twingate/kubernetes-operator/commit/2c4db2dd91bcd9c4926998fbc74f538aa3effc60))

- Ignore local claude settings
  ([`d678ee1`](https://github.com/Twingate/kubernetes-operator/commit/d678ee14c1873a4068a891addb117df0669d5532))

- Migrate from Coveralls to CodeCov for coverage reporting
  ([#899](https://github.com/Twingate/kubernetes-operator/pull/899),
  [`ef4510f`](https://github.com/Twingate/kubernetes-operator/commit/ef4510fcb73bd9b88cae7ad7186f711022ff485b))

- Remove goland from .envrc as its no longer used in this project
  ([`7de59fc`](https://github.com/Twingate/kubernetes-operator/commit/7de59fc4387438c2d0bbfb6bced6a7be351abfab))

- Update the connector version used in integration tests
  ([#911](https://github.com/Twingate/kubernetes-operator/pull/911),
  [`7e5fe32`](https://github.com/Twingate/kubernetes-operator/commit/7e5fe32382465387d90c08b60efe437879041106))

### Documentation

- Add CLAUDE.md and Claude Code settings
  ([#891](https://github.com/Twingate/kubernetes-operator/pull/891),
  [`3fe9576`](https://github.com/Twingate/kubernetes-operator/commit/3fe95769b2bb2987583458235092072d7f6d1ed8))

### Features

- Add K8s TLS secret object watch handler
  ([#909](https://github.com/Twingate/kubernetes-operator/pull/909),
  [`5691f3f`](https://github.com/Twingate/kubernetes-operator/commit/5691f3f081c36f768fed7e938008bd7f098e5a95))

- Support `certificateAuthorityCertSecretRef` on `TwingateResource` CRD
  ([#807](https://github.com/Twingate/kubernetes-operator/pull/807),
  [`77af191`](https://github.com/Twingate/kubernetes-operator/commit/77af19158b2a2fecd3de3776ca94a3716e2870fb))
