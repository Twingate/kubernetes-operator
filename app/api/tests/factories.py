...
from app.crds import ResourceDownstream, ResourceUpstream
...
VALID_CA_CERT_1 = "-----BEGIN CERTIFICATE-----\\nGGBRlvPg\n-----END CERTIFICATE-----"
...
class ResourceDownstreamFactory(factory.Factory):
    class Meta:
        model = ResourceDownstream

    port = 80


class ResourceUpstreamFactory(factory.Factory):
    class Meta:
        model = ResourceUpstream

    port = 8080


class WebAppResourceFactory(BaseResourceFactory):
    class Meta:
        model = WebAppResource

    downstream = factory.SubFactory(ResourceDownstreamFactory)
    upstream = factory.SubFactory(ResourceUpstreamFactory)
