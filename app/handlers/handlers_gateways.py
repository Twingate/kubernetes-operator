...
from app.handlers.base import fail, resolve_ref_to_backend_id, success
...
def _reconcile_gateway(body, spec, logger, memo, patch):
    ...
    # Resolve the referenced CA to its backend id (retries via TemporaryError if
    # the CA CRD hasn't synced to Twingate yet).
    x509_ca_id = resolve_ref_to_backend_id(
